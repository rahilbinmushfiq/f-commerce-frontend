...
export default function ContactUs() {
  ...
  //       liveChatButton.style.opacity = "0";
  //     } else {
  //       liveChatButton.style.pointerEvents = "auto";
  ...
  return (
    <>
      {/* <div
        id="live-chat"
        className="pointer-events-auto fixed bottom-3 right-3 z-[1] space-y-4 opacity-100 transition-[opacity] lg:bottom-5 lg:right-5"
      >
        <Image
          src={arrowIcon}
          alt="Arrow icon"
          className="mx-auto size-20 rotate-90 -scale-x-100 object-contain opacity-60"
        />
        <button className="float-right rounded-md bg-[#ced0fb] p-3 text-neutral-700 transition-[background-color] hover:bg-[#b3b3f1] hover:text-neutral-900">
          <PiChatText size={32} />
        </button>
      </div> */}
