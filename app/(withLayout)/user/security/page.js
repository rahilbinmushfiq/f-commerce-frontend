...
export default function Profile() {
  ...
  // const isBothProvidersPresent = () => user?.providerData.length > 1;
  ...
  //     // User has signed up with email and password
  ...
  // if (!!user) console.log(check());

  // console.log("authProviders", isPasswordProviderPresent);
